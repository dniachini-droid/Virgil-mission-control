...
Amended by OD-0002. The ensemble is a family of charming, compact, stylised, screen-faced robot astronauts, inspired by the warmth, readability, proportions and animation appeal of Bot Crossing while sharing none of its faces, characters or world. Compact rounded bodies with readable silhouettes; oversized expressive screen faces with an original glyph atlas; funny, distinctive and useful equipment; polished low-poly modelling; no realistic human anatomy. Each role is recognisable by silhouette, station, instruments, locomotion, ritual, handoff, idle and prohibited-action behaviour (`ROLE_PERFORMANCE_BIBLE.md`); role recognition comes from body shape and equipment, never colour alone. Virgil is a member of the same family: compact, the most expressive screen, visibly senior and more elaborately equipped, at a dense control centre, conducting without performing any worker's protected role. "Premium" means excellent stylised modelling, proportions, materials, lighting, composition, animation and interaction, not realism or severe abstraction.
...
Glassmorphism dashboards; rows of rectangular statistic cards as the primary experience; cheap clip-art, generic stock characters, incoherent asset-store mixtures and low-effort reskins (the earlier "cartoon astronauts" prohibition, corrected by OD-0002: charming stylised astro-bots are the intended direction); abstract cones or glowing spheres presented as finished characters; emoji faces or copied Bot Crossing faces; primitive spheres presented as a final visual language; interchangeable coloured avatars; constant uncontrolled movement; bloom that destroys detail; particle noise over paths or selectable objects; colour as the only state indicator; a 3D backdrop with all real work in text boxes; a folder browser disguised as the Mind; a bare node graph without environmental meaning; gold on anything not owner-authorised; any object that implies a model's private thoughts.

## 11. Quality bar and checkpoint

The Phase 0 spikes proved the stack; on a real GPU the owner judged their graphical execution a failure (OD-0002: a sparse debug visualisation of primitive geometry). Phase 0.5 (`docs/process/PHASE_0_5_PLAN.md`) rebuilds one hero Foundry bay, the four characters and one Mind cluster to the corrected direction in section 8, on the same event-gated pipeline. The bar: a deliberately designed game environment; characters appealing at first glance; four roles distinguishable in greyscale by silhouette and equipment; readable without tiny labels; clear foreground, middle ground and background; lighting that reveals form; controlled bloom; the operational sequence understandable primarily through action. Software rendering in a container cannot judge that bar; the owner judges it on a real GPU at the checkpoint (`docs/process/ART_DIRECTION_CHECKPOINT.md`).
