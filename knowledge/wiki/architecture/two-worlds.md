...
sources:
  ...
  - { kind: code_path, ref: docs/architecture/TWO_WORLDS.md }
claims:
  - id: C-worlds-coequal
    ...
    sources: [src-master-commission, docs/architecture/TWO_WORLDS.md]
