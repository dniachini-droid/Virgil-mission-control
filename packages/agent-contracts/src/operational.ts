...
export const ImplementationPlan = z.object({
  ...
  taskGraph: z.array(
    z.object({
      ...
      permittedPaths: z.array(RepoPath),
      requiredChecks: z.array(Id),
    }),
  ),
  permittedPaths: z.array(RepoPath).min(1),
...
export const AgentAuthorityGrant = z.object({
  ...
  permittedPaths: z.array(RepoPath),
  prohibitedPaths: z.array(RepoPath),
  requiredChecks: z.array(Id),
...
export const WorkOrder = z.object({
  ...
  nonGoals: z.array(z.string()),
  permittedSurfaces: z.array(RepoPath),
  protectedSurfaces: z.array(RepoPath),
...
export const RepairContract = ChainContext.extend({
  ...
  permittedFiles: z.array(RepoPath).min(1),
